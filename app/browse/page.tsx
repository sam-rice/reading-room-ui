...
const BrowsePage: FC = () => {
  ...
  const submit = () => console.log(`submitting search for "${query}" in ${category}`)

  return (
    <PageContainer className=" items-center justify-center">
      <h1 className={twMerge(dmSerifDisplay.className, "mb-10 text-4xl")} id="search-library">SEARCH LIBRARY</h1>
      <div className="flex h-72 w-full flex-col items-center justify-center space-y-7 bg-theme-beige-400">
        <input
          className="h-11 w-1/2 min-w-64 pl-3"
          value={query}
